...
namespace EFCoreNorthWindDb.Models;
...
public partial class NorthwndContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Server=BSD-BOOBATHIA01\\SQLEXPRESS;Database=NORTHWND;Integrated Security=True;TrustServerCertificate=True;");

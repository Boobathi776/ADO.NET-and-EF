...
public partial class NorthWindContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Server = BSD-BOOBATHIA01\\SQLEXPRESS;Database = NorthWind;Integrated Security =true;TrustServerCertificate=true;");
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if(!optionsBuilder.IsConfigured)
        {
            ...
            var connectionString = configSection["NorthWindDB"];
    ...
    {
        modelBuilder.Entity<CustomerOrderHistoryDto>().HasNoKey();

...
namespace EFCoreAdventureWorkPractice.Models;
...
public partial class AdventureWorks2019Context : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=BSD-BOOBATHIA01\\SQLEXPRESS;database=AdventureWorks2019;Integrated Security=True;Trust Server Certificate=True;");
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if(!optionsBuilder.IsConfigured)
        {
            ...
            var connectionString = configSection["AdventureWorksDbString"];
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EmployeeManagersDto>().HasNoKey();
